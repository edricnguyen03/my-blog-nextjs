...
const HomeAbout = () => {
    return (
        <section
            id="#about"
            className="flex flex-col items-center justify-center rounded-lg w-f bg-slate-950 py-12"
        >
            <Container classNames="flex flex-col  justify-center">
                <h2 className="mb-8 text-4xl text-center  font-semibold tracking-wide text-slate-50">
                    About Crafters
                </h2>
                <div className="flex flex-col gap-4 text-lg text-slate-300 px-4">
                    <p>
